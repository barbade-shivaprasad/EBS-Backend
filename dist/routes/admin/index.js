...
const panels_1 = __importDefault(require("../../miscellaneous/panels"));
...
Admin.getImg = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield upload_1.bucket.find({ $or: [{ filename: `${request.params.id}-poster.jpeg` }, { filename: `${request.params.id}-poster.png` }] }).toArray((err, files) => {
